...
const FormInputs = ({ setName, setEmail, setNumber, setCity, setHome, buttonSubmitValue }) => {
    ...
    return (
        <div>
            <label
                htmlFor="nombre"
                className="relative left-5 font-semibold md:left-1/4 text-my-warning"
            >
                Nombre completo:
            </label>
            ...
            <label
                htmlFor="email"
                className="relative left-5 top-7 font-semibold md:left-1/4 text-my-warning"
            >
                Email:
            </label>
            ...
            <div className="flex flex-col items-center mt-7">
                <input
                    type="text"
                    placeholder="Escriba la ciudad donde resides"
                    className="border rounded-md w-72 placeholder:text-center h-10 shadow md:w-3/6 md:mt-1 px-3 focus-visible:outline-none focus-visible:bg-slate-200 focus-visible:placeholder:text-gray-600"
                    onChange={handleCity}
                    minLength={4}
                    required
            ...
            <div className="flex flex-col items-center mt-7">
                <input
                    type="text"
                    placeholder="Escriba su domicilio actual"
                    className="border rounded-md w-72 placeholder:text-center h-10 shadow md:w-3/6 md:mt-1 px-3 focus-visible:outline-none focus-visible:bg-slate-200 focus-visible:placeholder:text-gray-600"
                    onChange={handleHome}
                    required
                />
